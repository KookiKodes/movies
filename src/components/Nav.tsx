...
import { CgClapperBoard, CgTv } from "solid-icons/cg";
  ...
  return (
    <nav class={styles.nav}>
      <ul class="nolist">
        ...
        <li>
          <A href="/" end aria-label="Home" activeClass="active">
            <AiOutlineHome size={24} />
          </A>
        </li>
        <li>
          <A href="/movie" aria-label="Movies" activeClass="active">
            <CgClapperBoard size={24} />
          </A>
        </li>
        <li>
          <A href="/tv" aria-label="TV Shows" activeClass="active">
            <CgTv size={24} />
          </A>
        </li>
        <li>
          <A href="/search" aria-label="Search" activeClass="active">
